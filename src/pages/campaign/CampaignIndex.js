                ...
                <div className="container h-100">
                    <div className="row h-100 ">
                        <div className="col-lg-6 col-xs-12 mx-auto  align-self-center searchTitle p-30">
                            <h2>最有質感的甜點活動</h2>
                            <p>品嚐獨一無二的精緻蛋糕</p>
                            <div className="searchBar w-100 d-flex
           justify-content-center ">
                                <input type="text" name="campaignSearch" id="campaignSearch" placeholder="立即搜尋你喜歡的活動..." />
                                <button className="searchBtn" type="submit"><i className="fas fa-search" /> 搜尋
                    </button>
                            </div>
                        </div>
                    </div>
            ...
            <div className="container-fluid tastingIntro py-5 position-relative d-none d-sm-block">
                ...
                <div className="col-lg-7  py-5  position-absolute tastingBg">
                </div>
                <div className="container py-5">
                    <div className="col-lg-4 py-5">
                        <h2 className="tastingTitle mb-4">甜點鑑賞 </h2>
                        <p className="tastingText">將清新的烏龍茶，融入北海道的鮮奶油中，淡淡茶香搭配鬆軟的海綿蛋糕，加上雙層焦糖腰果，豐富了味蕾，最後淋上海鹽奶油霜，沉穩而趣味的搭配。
                </p>
                        <p className="tastingText">
                            將清新的烏龍茶，融入北海道澤鮮奶油中，淡淡茶香搭配鬆軟的海綿蛋糕，加上雙層焦糖腰果，豐富了味蕾，淡淡茶香搭配鬆軟的海綿蛋糕，加上雙層焦糖腰果，豐富了味蕾，最後淋上海鹽奶油霜，沉穩而趣味的搭配。</p>
                        <a className="btn k_btn">
                            立刻購買<span className="btn-style" />
                        </a>
                    </div>
                </div>
                <div className="col-7 py-5 position-absolute tastingImg">
                </div>
            </div>
            ...
            <div className="illustration position-relative">
            </div>
            <div className="container-fluid experienceIntro py-5 position-relative d-none d-sm-block">
                ...
                <div className="col-7 py-5 position-absolute experientImg">
                </div>
            </div>
            <div className="container-fluid workshopIntro py-5 position-relative mb-5 d-none d-sm-block">
                <div className="col-7  py-5 position-absolute tastingBg">
                </div>
                <div className="container py-5">
                    <div className="col-4 py-5">
                        <h2 className="tastingTitle mb-4">甜點鑑賞 </h2>
